...
const branchA = new BankBranch("Branch B Information");
const branchB = new BankBranch("Branch A Information");
...
console.log(branchC.getBranchInfo()); // Output: Branch A Information
